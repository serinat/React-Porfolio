  ...
  return (
    <div>
      ...
      <p id="about" style={{ margin: 20 }}>Hi, there! My name is Serina Tsang, and welcome to my portfolio site! I am currently
                        enrolled at
                        the University of Washington Coding Bootcamp. In my portfolio are a few assignments and two 
                        projects built by my team,
                        using the knowledge and skills obtained during the first three quarters of my journey!</p>
      <p id="about2" style={{ margin: 20 }}>A little bit about myself: I graduated from the University of Washington with a
          ...
          and learn everyday to keep up with technology and to become a progressive, successful developer. While I
          ...
          setting higher goals and expectations for themselves, something I learned a bit later than planned
